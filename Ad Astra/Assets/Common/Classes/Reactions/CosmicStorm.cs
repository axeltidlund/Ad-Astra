...
public class CosmicStorm : Reaction
{
    ...
    void DoHit()
    {
        ...
        foreach (var enemy in hits)
        {
            ...
            damageable.Damage(reactionData.damage, reactionData.reactiveType, vec * 2f, .25f, Global.AugmentReactionTarget.CosmicStorm);
        }

        if (hitCount >= (1 / hitRate))
        {
            active = false;
            effect.Stop();
        }
